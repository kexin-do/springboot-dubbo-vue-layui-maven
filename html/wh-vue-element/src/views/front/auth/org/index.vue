<template>
  <section>
    ...
    <el-table :data="list" highlight-current-row :loading="loading.list" style="width: 100%;">
      ...
      <el-table-column prop="pOrgName" label="上级机构名称" width="180">
      </el-table-column>
      <el-table-column prop="orgSts" label="状态" width="80">
        <template slot-scope="scope">
          <div v-if="scope.row.orgSts === '1'">
          ...
          <div v-if="scope.row.orgSts !== '1'">
            <el-popover trigger="hover" placement="top">
              ...
              <p>停用时间: {{ scope.row.lstTime }}</p>
              <p>停用人: {{ scope.row.lstUser }}</p>
              <div slot="reference" class="name-wrapper">
